...
pub async fn get_cache_stats(app: AppHandle) -> Result<CacheStats, StorageError> {
    ...
    let completed_regions = data.regions.iter()
...
pub async fn update_cache_region(
    ...
    let region = data.regions.iter_mut()
...
pub async fn save_cached_tile(
    ...
    cache_data.tiles.insert(tile_key, TileMetadata {
        survey_id,
        zoom,
        x,
        y,
...
#[tauri::command]
pub async fn clear_survey_cache(
    app: AppHandle,
    survey_id: String,
