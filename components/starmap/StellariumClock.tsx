...
import { mjdToUTC, utcToMJD, formatDateForInput, formatTimeForInput } from '@/lib/starmap/utils';
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <PopoverTrigger asChild>
            <Button
              variant="ghost"
              className="h-auto px-4 py-2 bg-background/60 backdrop-blur-sm text-foreground hover:bg-background/80 flex flex-col items-center gap-0"
            >
