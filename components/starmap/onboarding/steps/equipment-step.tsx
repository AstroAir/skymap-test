            ...
            <div className="space-y-3 p-3 rounded-lg bg-muted/30">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <Label className="text-xs" htmlFor="onboarding-manual-focal-length">{t('fov.focalLength')} (mm)</Label>
                  <Input
                    id="onboarding-manual-focal-length"
                    type="number"
                ...
                <div className="space-y-1">
                  <Label className="text-xs" htmlFor="onboarding-manual-aperture">{t('equipment.aperture')} (mm)</Label>
                  <Input
                    id="onboarding-manual-aperture"
                    type="number"
          ...
          {showManualCamera && (
            <div className="space-y-3 p-3 rounded-lg bg-muted/30">
              <div className="grid grid-cols-3 gap-2">
                <div className="space-y-1">
                  <Label className="text-xs" htmlFor="onboarding-manual-sensor-width">{t('fov.sensorWidth')} (mm)</Label>
                  <Input
                    id="onboarding-manual-sensor-width"
                    type="number"
                ...
                <div className="space-y-1">
                  <Label className="text-xs" htmlFor="onboarding-manual-sensor-height">{t('fov.sensorHeight')} (mm)</Label>
                  <Input
                    id="onboarding-manual-sensor-height"
                    type="number"
                ...
                <div className="space-y-1">
                  <Label className="text-xs" htmlFor="onboarding-manual-pixel-size">{t('fov.pixelSize')} (μm)</Label>
                  <Input
                    id="onboarding-manual-pixel-size"
                    type="number"
