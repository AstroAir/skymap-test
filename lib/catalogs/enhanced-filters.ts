/**
 * Enhanced Sky Atlas Filters
 * Ported from NINA's SkyAtlasVM filter implementation
 * 
 * Adds transit time filtering, altitude duration filtering, and other advanced options
 */
...
export interface EnhancedSearchFilters {
  ...
  // Sort options
  orderByField: SkyAtlasOrderByField;
  orderByDirection: 'asc' | 'desc';
}

export type SkyAtlasOrderByField = 
  | 'name'
  | 'magnitude'
  | 'sizeMax'
  | 'ra'
...
export interface FilteredDSOResult {
  id: string;
  name: string;
  type: string;
  constellation: string;
...
export const DEFAULT_ENHANCED_FILTERS: EnhancedSearchFilters = {
  objectName: '',
  objectTypes: [],
  constellation: '',
...
/**
 * Apply enhanced filters to a list of DSO objects
...
function sortResults(
  results: FilteredDSOResult[],
  field: SkyAtlasOrderByField,
  direction: 'asc' | 'desc'
): FilteredDSOResult[] {
